...
Below is an incomplete idea for an extension of concept-vectors. The core concern is handling typos.
...
Split all strings such that they contain discrete white space characters, continuous alpha sequences, continuous digit sequences, or discrete remaining glyphs; then apply the two functions.
